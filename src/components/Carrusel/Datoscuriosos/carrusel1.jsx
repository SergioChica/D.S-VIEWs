...
import { Datoscuriosos1, Datoscuriosos2, Datoscuriosos3, Datoscuriosos4, Datoscuriosos5 } from './Datoscuriosos';
            ...
            <div className="absolute bottom-[-2rem] left-1/2 transform -translate-x-1/2 flex gap-2">
                {slides.map((_, index) => (
                    <button
                        ...
                        className={`w-3 h-3 rounded-full ${index === selectedIndex ? 'bg-[#F0ECE3]' : 'bg-[#3F3D56]'}`}
                    />
                ))}
            </div>
        </div>
