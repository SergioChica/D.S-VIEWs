...
export const Home = () => {
  ...
  <ul className='flex items-center justify-around z-10  my-[1.5rem] '>
...
<li>
<p className=' text-[40px] cursor-pointer text-[#1E1E1E]   '>Inventario</p>
</li>
<li>
...
<div />
{/* <svg className='fixed z-0 top-0 right-0' width="1450" height="1225" viewBox="0 0 457 569" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div className='fixed z-1 top-[-120px] right-[-780px] w-[2050px] h-[2225px] rounded-[50%] bg-gradient-to-t from-[#381975]  to-[#692FDB] '></div>
